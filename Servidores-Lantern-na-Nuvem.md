Os servidores Lantern na nuvem são pequenos [EC2 instances](http://en.wikipedia.org/wiki/Amazon_Elastic_Compute_Cloud) da Amazon que servem como reservas quando não tem usuários online suficientes.
