...
Please see the complete [Privacy](https://github.com/getlantern/lantern/wiki/Privacy) page.
...
For specific details on what information Lantern collects and for what purpose, see the <a href="https://docs.google.com/a/getlantern.org/spreadsheet/pub?key=0Ap6nn0WEcFTRdHUtTm9GcFpsNFpoOGFXQlBfODN4TkE&single=true&gid=0&output=html" target="_blank">Lantern Information Disclosure Matrix</a>.
...
We will not use any information we collect for any other purpose other than providing the Lantern service to you and other users. If you would like us to delete your account and the associated information that has been collected about it, please email us at privacy@getlantern.org.
