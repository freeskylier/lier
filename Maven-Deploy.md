We keep our maven repository on S3 using the Spring [maven/s3 plugin](https://github.com/SpringSource/aws-maven). You need to set your s3 credentials in settings.xml as in:
