目前在Linux平台，我们只有Ubuntu的安装包。如果您能提供对其它Linux发行版的支持，我们将非常高兴。其它发行版当然也可以[从源代码开始编译安装](https://github.com/getlantern/lantern/blob/master/README.md#setting-up-a-development-environment)。
